...
return [
    ...
    'node' => [
        ...
        'daemon_off_config_updated' => 'A configuração do daemon <strong>foi atualizada</strong>, no entanto, ocorreu um erro ao tentar atualizar automaticamente o arquivo de configuração no Daemon. Você irá precisar atualizar manualmente o arquivo de configuração (core.json) para aplicar as mudanças.',
    ],
    'allocations' => [
    ...
    'nest' => [
        ...
        'egg' => [
            ...
            'invalid_copy_id' => 'O Egg selecionado para copiar um script não existe ou está copiando um script em si mesmo.',
            'must_be_child' => 'A diretiva "Copiar configurações de" para este Egg deve ser uma opção filho para o Nest selecionado.',
            'has_children' => 'Este Egg é o pai de um ou mais outros Eggs. Por favor, apague esses Eggs antes de apagar este Egg.',
        ],
        'variables' => [
            'env_not_unique' => 'A variável de ambiente :name precisa ser única para esse Egg.',
    ...
    'packs' => [
        ...
        'invalid_archive_exception' => 'O arquivo do pacote fornecido parece estar ausente no arquivo.tar.gz ou import.json necessário no diretório base.',
    ],
    'subusers' => [
    ...
    'locations' => [
        'has_nodes' => 'Não é possível excluir um local que tenha nós ativos anexados.',
    ],
    'users' => [
